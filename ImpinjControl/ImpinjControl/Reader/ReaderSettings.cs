...
namespace RFIDIntegratedApplication.Reader
{
    public class ReaderSettings
    {
        ...
        public void GetReaderCapabilities()
        {
            ...
            #region Print Reader Capabilities
            ...
            if (msg != null && msg.TagReportData != null)
            {
                ...
                for (int i = 0; i < msg.TagReportData.Length; i++)
                {
                    ...
                    if (msg.TagReportData[i].ChannelIndex != null)
                    {
                        ...
                        _tagInfo.Frequency = (int)(1000000 * RFIDReaderParameter.ReaderCapabilities.FrequencyDic[_tagInfo.ChannelIndex]);
                    }
                    ...
                    try
                    {
                        ...
                        {
                            _mainform.EnqueueTagInfo(_tagInfo);
                        }));
                    }
                    catch
                    {
            ...
            if (msg.ReaderEventNotificationData.ROSpecEvent != null)
            {
                switch (msg.ReaderEventNotificationData.ROSpecEvent.EventType)
                {
                    case ENUM_ROSpecEventType.Start_Of_ROSpec:
                        ...
                        {
                            //_mainform.Clear();
                            _mainform.UpdateComponentStatus((int)ENUM_ROSpecEventType.Start_Of_ROSpec, SARParameter.IsSimulation);
                        }));
                        break;
                    case ENUM_ROSpecEventType.End_Of_ROSpec:
                        _mainform.Invoke(method: new Action(() =>
                        {
                            _mainform.UpdateComponentStatus((int)ENUM_ROSpecEventType.End_Of_ROSpec, SARParameter.IsSimulation);
                        }));
                        break;
        ...
        /// </summary>
        public void UpdateRFIDReaderPara()
        {
